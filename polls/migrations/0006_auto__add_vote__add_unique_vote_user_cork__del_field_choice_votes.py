...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'polls_vote', (
            ...
            ('cork', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Cork'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'polls', ['Vote'])

        # Adding unique constraint on 'Vote', fields ['user', 'cork']
        db.create_unique(u'polls_vote', ['user_id', 'cork_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['user', 'cork']
        db.delete_unique(u'polls_vote', ['user_id', 'cork_id'])
