...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'polls_reference', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Reference.url'
        db.alter_column(u'polls_reference', 'url', self.gf('django.db.models.fields.TextField')())
