...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Class.update'
        db.add_column(u'classes_class', 'update',
    ...
    def backwards(self, orm):
        # Deleting field 'Class.update'
        db.delete_column(u'classes_class', 'update')
    ...
    models = {
        ...
        u'classes.basketclassmembership': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'open_for_voting': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
