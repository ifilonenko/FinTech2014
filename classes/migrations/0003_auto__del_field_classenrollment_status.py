...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClassEnrollment.status'
        db.delete_column(u'classes_classenrollment', 'status')


    def backwards(self, orm):
        # Adding field 'ClassEnrollment.status'
        db.add_column(u'classes_classenrollment', 'status',
