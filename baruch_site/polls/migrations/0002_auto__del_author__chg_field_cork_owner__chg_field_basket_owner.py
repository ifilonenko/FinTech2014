...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cork.owner'
        db.alter_column(u'polls_cork', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Basket.owner'
        db.alter_column(u'polls_basket', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Cork.owner'
        db.alter_column(u'polls_cork', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Author']))

        # Changing field 'Basket.owner'
        db.alter_column(u'polls_basket', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Author']))
