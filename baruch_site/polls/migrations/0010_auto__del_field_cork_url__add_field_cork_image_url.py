...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cork.url'
        db.delete_column(u'polls_cork', 'url')

        # Adding field 'Cork.image_url'
        db.add_column(u'polls_cork', 'image_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cork.url'
        db.add_column(u'polls_cork', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'Cork.image_url'
        db.delete_column(u'polls_cork', 'image_url')
